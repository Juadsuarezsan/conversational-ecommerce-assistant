...
Hybrid retrieval (BM25 + dense + RRF + Cohere rerank) over a 50K-product catalog. LangGraph agent routes between product search, cart management, refund handling, and escalation.
